...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/0LSxFE4iOF)
...
```sh
npx nx serve Office_Automation
```

To create a production bundle:

```sh
npx nx build Office_Automation
```

To see all available targets to run for a project, run:

```sh
npx nx show project Office_Automation
```
